print("What do these mean to you: @classmethod, @staticmethod, @property?")

"""
These are decorators. A decorator is a special kind of function that-
 either takes a function and returns a function, 
or takes a class and returns a class. The @ symbol is-
 just syntactic sugar that allows you to decorate something-
...
def my_func(stuff):
    do_things
my_func = my_decorator(m_func)


#The decorators @classmethod, @staticmethod, & @property, are used on functions defined within a classes
